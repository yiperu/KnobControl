Pod::Spec.new do |s|
  ...
  s.author             = { "Henry Ambicho T." => "hambicho@everis.com" }
  # Or just: s.author    = "Henry Ambicho T."
  # s.authors            = { "Henry Ambicho T." => "hambicho@everis.com" }
  # s.social_media_url   = "http://twitter.com/Henry Ambicho T."
  ...
  s.source       = { :git => "https://github.com/yiperu/KnobControl.git",  :tag => "1.0.0" }
  #s.source       = { :path => '.' }
